...
// 🔥 EL NUEVO MODAL DE APORTE A LA AYUDA CORREGIDO
 ...
 Widget? _construirFABGrupo() {
    ...
    // Pestaña 2: Cobros (Splitwise)
    else if (_tabController.index == 2) {
      return FloatingActionButton.extended(
        key: const ValueKey('fab_cobro'), // Llave para animación
        heroTag: 'fab_principal',
        backgroundColor: colorScheme.primary,
        foregroundColor: colorScheme.onPrimary,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
    ...
    // Si estamos en historial, propuestas o ayudas, no mostramos botón (se oculta con animación)
    return null; 
  }
