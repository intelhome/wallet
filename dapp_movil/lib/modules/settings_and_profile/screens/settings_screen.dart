...
import 'package:dapp_movil/modules/auth_and_security/screens/splash_screen.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  UserConfigService get configService =>
      Provider.of<UserConfigService>(context, listen: false);
  ...
  Future<void> _cambiarPresupuesto() async {
    TextEditingController controller = TextEditingController(
      text: _presupuestoMensual.toStringAsFixed(0),
    );
    ...
    bool? guardado = await showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              "Define tu límite visual de gastos en TTC para este mes.",
    ...
    if (guardado == true) {
      ...
      UIHelper.showCustomSnackbar(
        "Presupuesto actualizado a TTC ${_presupuestoMensual.toStringAsFixed(0)}",
        isError: false,
      );
  ...
  Future<void> _recuperarConfiguracionesRemotas() async {
    ...
    if (data != null && mounted) {
      setState(() {
        ...
        _paypalEmailController.text = _paypalEnabled
            ? "********@paypal.com"
            : "";
  ...
  void _guardarPreferenciasNotificaciones() async {
    ...
    bool ok = await configService.updateNotificationPreferences(
      _notifyEmail,
      _notifyWhatsapp,
      _notifyPush,
    );
    if (!ok)
      UIHelper.showCustomSnackbar(
        "Error al sincronizar preferencias",
        isError: true,
      );
  }
  ...
  Future<void> _guardarPreferenciaCrowdfunding(bool val) async {
    ...
    if (!ok) {
      UIHelper.showCustomSnackbar(
        "Error al actualizar visibilidad de Crowdfunding",
        isError: true,
      );
      setState(() => _showCrowdfunding = !val);
      showCrowdfundingGlobal.value = !val;
                          ...
                          try {
                            final res = await http.post(
                              ...
                              headers: {
                                ...
                                if (authCore.jwtToken != null)
                                  "Authorization":
                                      "Bearer ${authCore.jwtToken}",
                              },
                              body: jsonEncode({
                                "walletAddress": authCore.publicAddress
                                    .toLowerCase(),
                            ...
                            if (res.statusCode == 200) {
                              ...
                              ScaffoldMessenger.of(this.context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    "¡Doble Factor de Seguridad Activado! 🛡️",
                                  ),
            ...
            ElevatedButton.icon(
              ...
              onPressed: actualizando
                  ...
                  : () async {
                      ...
                      print(
                        "📝 [LOG UI] Llamando al servicio modular para actualizar límite a $newLimit",
                      );
                      bool success = await configService.updateDailyLimit(
                        newLimit,
                      );
                      ...
                      if (success) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              "Límite actualizado de forma segura 🔒",
                              style: TextStyle(color: Colors.white),
                            ),
                            backgroundColor: Colors.green,
                          ),
              ...
              label: Text(
                actualizando ? "Guardando..." : "Autenticar",
          ...
          title: Row(
            children: [
              Icon(
                ...
                color: isFreezing ? Colors.red : Colors.green,
              ),
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const InitialRouter(),
                  ),
              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        title: const Text(
                          "Modo Negocio (TTC Business)",
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ),
                        subtitle: const Text(
                          "Convierte tu app en un Punto de Venta",
                          ...
                          builder: (context, isActive, _) {
                            return Switch(
                              ...
                              onChanged: (val) {
                                if (val == true) {
                                  final planConfig =
                                      Provider.of<PlanConfigService>(
                                        context,
                                        listen: false,
                                      );
                                  final authCore = Provider.of<AuthCoreService>(
                                    context,
                                    listen: false,
                                  );
                                  if (!planConfig.hasFeature(
                                    authCore.currentTier,
                                    'OPCION_NEGOCIO',
                                  )) {
                                    PremiumBlockerModal.show(
                                      context,
                                      planRequerido: "PREMIUM",
                                      featureName:
                                          "TTC Business (Punto de Venta)",
                                    );
                                    return;
                                  }
                                }
                  ...
                  child: Column(
                    children: [
                      ...
                      ValueListenableBuilder<bool>(
                        ...
                        builder: (context, isCustom, _) {
                          return ListTile(
                            ...
                            subtitle: const Text(
                              "Usar colores basados en tu Smart Avatar",
                            ),
                            trailing: Switch(
                              value: isCustom,
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          "Actual: ${_presupuestoMensual.toStringAsFixed(0)} TTC / mes",
                          style: TextStyle(
                            color: onSurfaceColor.withOpacity(0.6),
                          ),
                        ),
                ...
                Card(
                  ...
                  child: SwitchListTile(
                    ...
                    title: Text(
                      "Permitir Análisis de Patrones",
                      style: TextStyle(color: onSurfaceColor),
                    ),
                    subtitle: Text(
                      "AI Brain optimizará tus rutas de gas.",
                      style: TextStyle(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: Text(
                          "Autenticador de Google (2FA)",
                          style: TextStyle(color: onSurfaceColor),
                        ),
                        subtitle: Text(
                          _is2faEnabled
                              ? "Activado y protegiendo tu cuenta"
                        ...
                        onTap: _is2faEnabled
                            ? () {
                                UIHelper.showCustomSnackbar(
                                  "El 2FA está activado. Contacte a soporte para desactivarlo.",
                                  isError: false,
                                );
                              }
                      ...
                      Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: const Text(
                            "Congela instantáneamente todas las salidas de dinero si crees que tu cuenta está en riesgo.",
                          ),
                          trailing: _isLoadingSecurity
                              ...
                              : Switch(
                                  ...
                                  value: _isFrozen,
                                  onChanged: (val) async {
                                    String? codigo = await _pedirCodigo2FA(
                                      context,
                                      val,
                                    );
                                    ...
                                    String resultado = await userService
                                        .toggleAccountFreeze(val, codigo);
                                    if (mounted)
                                      setState(
                                        () => _isLoadingSecurity = false,
                                      );
                                    ...
                                    if (resultado == "SUCCESS") {
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        SnackBar(
                                          content: Text(
                                            val
                                                ? "Cuenta Congelada 🥶. Envíos bloqueados."
                                                : "Cuenta Reactivada 🟢. Operaciones normales.",
                                          ),
                                          backgroundColor: val
                                              ? Colors.red
                                              : Colors.green,
                      ...
                      ListTile(
                        ...
                        subtitle: const Text(
                          "Revisa dónde está abierta tu sesión y revoca accesos.",
                        ),
                        trailing: Icon(
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const DecoyWalletSetupScreen(),
                            ),
                          );
                        },
                      ),
                            ...
                            if (_paypalEnabled) ...[
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  onPressed: _guardandoPaypal
                                      ? null
                                      : () async {
                                          if (_paypalEmailController.text
                                              .trim()
                                              .isEmpty) {
                                            UIHelper.showCustomSnackbar(
                                              "Por favor ingresa tu correo de PayPal",
                                              isError: true,
                                            );
                                            return;
                                          }
                                          setState(
                                            () => _guardandoPaypal = true,
                                          );
                                          print(
                                            "📝 [LOG UI] Guardando pasarela PayPal...",
                                          );
                                          bool ok = await configService
                                              .savePayPalConfig(
                                                _paypalEnabled,
                                                _paypalEmailController.text,
                                              );
                                          setState(
                                            () => _guardandoPaypal = false,
                                          );
                                          if (ok) {
                                            UIHelper.showCustomSnackbar(
                                              "¡Pasarela de PayPal configurada de forma encriptada!",
                                            );
                                          } else {
                                            UIHelper.showCustomSnackbar(
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          String? privateKeyHex = await authCore
                              .exportPrivateKey();
                          if (!mounted) return;
                          if (privateKeyHex != null) {
                            ...
                            UIHelper.showCustomSnackbar(
                              "Autenticación requerida para ver la llave.",
                              isError: true,
                            );
                          }
                        },
