            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  decoration: InputDecoration(labelText: "Selecciona tu Bóveda", prefixIcon: const Icon(Icons.diversity_3_rounded, color: Colors.deepPurpleAccent), border: OutlineInputBorder(borderRadius: BorderRadius.circular(16))),
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: isProcessing ? null : () async {
                    ...
                    if (res == "Exito") { 
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Solicitud de ayuda enviada al grupo"), backgroundColor: Colors.green)); 
                      _cargarDeudas();
                    } else { 
