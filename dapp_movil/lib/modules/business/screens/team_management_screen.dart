...
import 'package:dapp_movil/modules/business/screens/team_departments_tab.dart';
import 'package:dapp_movil/modules/business/screens/team_members_tab.dart';
...
class _TeamManagementScreenState extends State<TeamManagementScreen> {
  ...
  Future<void> _eliminarMiembro(String identifier) async {
    ...
    bool? confirm = await UIHelper.mostrarConfirmacion(
      context: context, 
      titulo: "Remover", 
      mensaje: "¿Seguro que deseas remover a este miembro?", 
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Gestion Comercial", style: TextStyle(fontWeight: FontWeight.bold)),
          actions: [
            IconButton(
          ...
          bottom: const TabBar(
            ...
            tabs: [
              ...
              Tab(icon: Icon(Icons.domain_rounded), text: "Areas"),
        ...
        body: TabBarView(
          children: [
            TeamMembersTab(
              ...
              onRemoveMember: _eliminarMiembro,
            ),
            TeamDepartmentsTab(
