...
class _VaultsScreenState extends State<VaultsScreen> {
  ...
  //late Future<List<dynamic>> _vaultsFuture;
  ...
  // void _cargarBovedas() {
  //   setState(() {
  //     _vaultsFuture = vaultService.getUserVaults();
  //   });
  // }
      ...
      body: _isLoading && _vaults.isEmpty
          ...
          : _vaults.isEmpty
              ? UIHelper.emptyState(
                  ...
                  title: "No tienes ahorros activos",
                  message: "Crea una Ucha flexible para tus metas cortas o un Plazo Fijo para ganar intereses.",
                  actionLabel: "Crear mi primer bolsillo",
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(color: isFlexible ? Colors.blueAccent.withOpacity(0.1) : Colors.purpleAccent.withOpacity(0.1), shape: BoxShape.circle),
                                      child: Icon(isFlexible ? Icons.savings_rounded : Icons.lock_clock_rounded, color: isFlexible ? Colors.blueAccent : Colors.purpleAccent, size: 32),
                                    ),
                                    ...
                                    if (isFlexible)
                                      IconButton(
                                        style: IconButton.styleFrom(backgroundColor: Colors.blueAccent.withOpacity(0.1), foregroundColor: Colors.blueAccent),
